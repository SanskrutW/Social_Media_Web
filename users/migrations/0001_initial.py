...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wing', models.CharField(blank=True, choices=[('INFORMATION TECHNOLOGY','INFORMATION TECHNOLOGY',),
    ...
    ('ELECTRONICS AND TELECOMMUNICATION','ELECTRONICS AND TELECOMMUNICATION'),], max_length=10)),
